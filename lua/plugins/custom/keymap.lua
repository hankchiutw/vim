...
function M.set()
  ...
  -- Map Alt+o(Command+o for mac) in normal mode to jump to older cursor position (like <C-o>)
  vim.keymap.set("n", "<A-o>", "<C-o>", { noremap = true })
  vim.keymap.set("n", "<D-o>", "<C-o>", { noremap = true })
  -- Map Alt+i(Command+i for mac) in normal mode to jump to newer cursor position (like <C-i>)
  vim.keymap.set("n", "<A-i>", "<C-i>", { noremap = true })
  vim.keymap.set("n", "<D-i>", "<C-i>", { noremap = true })
